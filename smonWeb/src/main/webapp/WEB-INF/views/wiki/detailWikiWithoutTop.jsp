...
<link href="<%=request.getContextPath() %>/bootstrap/bower_components/bootstrap/dist/css/bootstrap.css" rel="stylesheet" />
<link href="<%=request.getContextPath() %>/css/jquery-ui.css" rel="stylesheet" type="text/css" media="screen" />
<link href="<%=request.getContextPath() %>/css/theme.css" rel="stylesheet" type="text/css" media="screen" />
...
<link href="<%=request.getContextPath() %>/css/app/navigation.css" rel="stylesheet" type="text/css" />
<link href="<%=request.getContextPath() %>/bootstrap/bower_components/morrisjs/morris.css" rel="stylesheet" />
<link href="<%=request.getContextPath() %>/bootstrap/bower_components/bootstrap-datetimepicker/bootstrap-datetimepicker.min.css" rel="stylesheet" type="text/css" />
<link href="<%=request.getContextPath() %>/css/chosen.css" rel="stylesheet" />
<link href="<%=request.getContextPath() %>/css/app/common.css" rel="stylesheet" /><!-- 비밀번호 변경 common.css -->
...
<script src="<%=request.getContextPath() %>/js/jquery.preapply.js"></script>
...
<script src="<%=request.getContextPath() %>/bootstrap/bower_components/bootstrap-datetimepicker/bootstrap-datetimepicker.js"></script>
<script src="<%=request.getContextPath() %>/js/window.js"></script>

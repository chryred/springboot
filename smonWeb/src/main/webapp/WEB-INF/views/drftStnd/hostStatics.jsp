...
<script type="text/javascript">
	...
	function makeChart() {
		...
		$.ajax({
			url 			: 	contextPath + "searchHostResult.do",
			type			:	"POST"		,
			data			:	postData	,
			dataType 		: 	"json"		,
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><small>진행자 통계 관리</small></h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
    	...
    	<div class="col-lg-12">
        	<div class="panel panel-default">
            	<div class="panel-heading">
                	<i class="fa fa-bullhorn fa-fw"></i><!-- <span class="fa arrow"></span> -->&nbsp;공유회 진행자 통계관리 화면입니다.
                </div>
                <!-- /.panel-heading -->
